...
export function renderOrderSummary() {
        ...
        <div class="cart-item-details-grid">
          ...
          <div class="cart-item-details">
            ...
            <div class="product-quantity
              ...
              <input class="quantity-input js-input-link js-quantity-input-${matchingProduct.id}" data-product-id="${matchingProduct.id}">
  ...
  document.querySelectorAll('.js-input-link')
  .forEach((link) => {
